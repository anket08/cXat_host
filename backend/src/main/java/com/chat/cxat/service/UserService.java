...
public class UserService {
        ...
        public User register(User user) {
                ...
                User temp = userRepository.findByEmail(
                                user.getEmail());
        ...
        public String resetPassword(
                ...
                if (code == null || user.getResetCode() == null || !code.trim().equals(user.getResetCode().trim()))
                        return "Invalid code";
        ...
        public String verifyRegisterOtp(
                ...
                if (code == null || user.getRegisterOtp() == null || !code.trim().equals(user.getRegisterOtp().trim()))
                        return "Invalid OTP";
